...
student1.name = "Natdanai Pakpoom";
student1.weight = 50.5f;
...
student3.name = "Jaruvit Sangkaewsirikul";
student3.weight = 85.5f;
...
Console.WriteLine(student1.name + " 653450088-3");